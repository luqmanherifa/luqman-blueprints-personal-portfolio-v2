    ...
    <section className="pb-16 sm:pb-10">
      ...
      `}
            ...
            <motion.p
              ...
              animate={{ x: [-150, 0], opacity: 1 }}
              transition={{ delay: 0.1 }}
              className="mt-4 mb-4 flex items-center justify-center gap-1 text-center text-base italic text-white dark:text-blue-100"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 640"
                className="h-3.5 w-3.5 fill-current text-white dark:text-blue-100 sm:hidden"
              >
